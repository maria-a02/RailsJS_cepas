...
class MagazinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create magazine" do
    assert_difference('Magazine.count') do
      post magazines_url, params: { magazine: { editor: @magazine.editor, name: @magazine.name, reviewer: @magazine.reviewer, writer: @magazine.writer } }
    end
  ...
  test "should update magazine" do
    patch magazine_url(@magazine), params: { magazine: { editor: @magazine.editor, name: @magazine.name, reviewer: @magazine.reviewer, writer: @magazine.writer } }
